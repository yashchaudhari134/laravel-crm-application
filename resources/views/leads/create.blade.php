            ...
            <form action="{{ route('leads.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-sm text-slate-500 mb-5">
                        Enter the lead and company details.
                    </p>
                ...
                <div class="mb-8 pt-6 border-t border-slate-200">
                    ...
                    <p class="text-sm text-slate-500 mb-5">
                        Assign the source, status and salesperson.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                <option value="Follow-up" {{ old('status') == 'Follow-up' ? 'selected' : '' }}>
                                    Follow-up
                                </option>
                                ...
                                <option value="Proposal Sent" {{ old('status') == 'Proposal Sent' ? 'selected' : '' }}>
                                    Proposal Sent
                                </option>
                            ...
                            <select
                                ...
                                @foreach ($salespeople as $salesperson)
                                    ...
                                    <option
                                        ...
                                        {{ old('assigned_salesperson_id') == $salesperson->id ? 'selected' : '' }}>
                                        {{ $salesperson->name }}
                                    </option>
                ...
                <div class="mb-8 pt-6 border-t border-slate-200">
                    ...
                    <p class="text-sm text-slate-500 mb-5">
                        Schedule the next follow-up and add useful notes.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full border border-slate-300 rounded-xl px-4 py-3 bg-slate-50 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none transition">{{ old('notes') }}</textarea>
