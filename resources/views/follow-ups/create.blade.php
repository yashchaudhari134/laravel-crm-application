            ...
            <form action="{{ route('follow-ups.store') }}" method="POST">
                ...
                <div class="mb-8">
                    ...
                    <textarea name="notes"
                              ...
                              class="w-full border border-slate-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-none">{{ old('notes') }}</textarea>
